...
import { Venue, VenueStatus } from '../../src/microservices/venue/entities/venue.entity';
 ...
 */
export function createMockVenueList(count: number, overrides?: Partial<Venue>): Venue[] {
