...
export class DatabaseSecurityController {
  ...
  @ApiOperation({ 
    ...
    description: 'Returns comprehensive database security status including SSL configuration and connection details'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Tests database connection and verifies SSL encryption is working properly'
  })
  @ApiResponse({ 
    status: 200, 
