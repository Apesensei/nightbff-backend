...
describe('AuditService', () => {
  ...
  describe('getAuditLogsInRange', () => {
    it('should retrieve audit logs within date range', async () => {
      ...
      expect(mockQueryBuilder.where).toHaveBeenCalledWith('audit_log.createdAt >= :startDate', { startDate });
      expect(mockQueryBuilder.andWhere).toHaveBeenCalledWith('audit_log.createdAt <= :endDate', { endDate });
