...
export class AuditController {
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves audit logs for a specific database table with pagination",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves audit logs within a specified date range with pagination",
  })
  @ApiResponse({
    status: 200,
    description: "Audit logs retrieved successfully",
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves audit logs that contain sensitive information like passwords or tokens",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves comprehensive audit statistics including operation counts and activity summaries",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Exports audit logs in JSON or CSV format for compliance purposes",
  })
  @ApiResponse({
    status: 200,
  ...
  async exportAuditLogs(
    ...
    @Query(
      "format",
      new DefaultValuePipe("json"),
      new ParseEnumPipe(["json", "csv"]),
    )
    format: "json" | "csv",
  ) {
    const start = new Date(startDate);
  ...
  @ApiOperation({
    ...
    description:
      "Removes audit logs older than specified number of days (maintenance operation)",
  })
  @ApiResponse({
    status: 200,
  ...
  async cleanupOldAuditLogs(
    ...
    const deletedCount =
      await this.auditService.cleanupOldAuditLogs(olderThanDays);
