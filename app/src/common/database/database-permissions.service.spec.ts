...
describe('DatabasePermissionsService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<DatabasePermissionsService>(DatabasePermissionsService);
  ...
  describe('createReadOnlyUser', () => {
    it('should create read-only user successfully', async () => {
      ...
      const result = await service.createReadOnlyUser('test_readonly', 'password123');
  ...
  describe('createApplicationUser', () => {
    it('should create application user successfully', async () => {
      ...
      const result = await service.createApplicationUser('test_app', 'password123');
  ...
  describe('createMigrationUser', () => {
    it('should create migration user successfully', async () => {
      ...
      const result = await service.createMigrationUser('test_migration', 'password123');
  ...
  describe('getUserTablePermissions', () => {
    it('should return user table permissions', async () => {
      ...
      const result = await service.getUserTablePermissions('test_user', 'users');
  ...
  describe('testUserConnection', () => {
    it('should test user connection successfully', async () => {
      ...
      const result = await service.testUserConnection('test_user', 'password123');
    ...
    it('should handle connection test failure', async () => {
      ...
      const result = await service.testUserConnection('test_user', 'wrong_password');
  ...
  describe('getSecuritySummary', () => {
    it('should return security summary', async () => {
      ...
      expect(result).toEqual({
        ...
        recommendations: expect.arrayContaining([
          ...
          'Consider creating dedicated application users',
        ]),
      });
    });
    ...
    it('should handle errors in security summary', async () => {
      ...
      jest.spyOn(service, 'getDatabaseUsers').mockRejectedValue(new Error('Database error'));
  ...
  describe('createProductionUsers', () => {
    it('should create all production users', async () => {
      ...
      mockConfigService.get.mockImplementation((key: string) => {
        switch (key) {
          case 'POSTGRES_READONLY_PASSWORD': return 'readonly_pass';
          case 'POSTGRES_APP_PASSWORD': return 'app_pass';
          case 'POSTGRES_MIGRATION_PASSWORD': return 'migration_pass';
          default: return 'default_pass';
        }
      });
