...
describe('JWT Strategy', () => {
  ...
  describe('Constructor Validation', () => {
    it('should throw error when JWT_SECRET is not set', () => {
      ...
      expect(() => new JwtStrategy(mockConfigService as any, mockAuthRepository))
  ...
  describe('Strategy Configuration', () => {
    it('should configure JWT extraction from Authorization header', () => {
      ...
      const strategy = new JwtStrategy(mockConfigService as any, mockAuthRepository);
  ...
  describe('Token Validation', () => {
    it('should validate token with valid user ID', async () => {
      ...
      const strategy = new JwtStrategy(mockConfigService as any, mockAuthRepository as any);
    ...
    it('should throw UnauthorizedException when user is not found', async () => {
      ...
      await expect(strategy.validate(payload))
        .rejects.toThrow('Token validation failed due to internal error');
    });
